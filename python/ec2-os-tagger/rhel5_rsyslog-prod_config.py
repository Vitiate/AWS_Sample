...
startCommand = "service rsyslog reload"

# only used for multi vpc accounts Filters=[{'Name': 'vpc-id', 'Values':[ vpcId ]}], 'i-057909699d188df23'
vpcId = " vpc-0b0fb67b6d35d0dbf"
# Filters=[]{'Name': 'instance-id', 'Values':[  'i-00f20840a5128e24a' ]}
